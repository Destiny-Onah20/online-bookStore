...
exports.validateBilling = exports.validateBookInput = exports.validateAdminLogin = exports.validateAdmin = exports.validateUserInput = void 0;
...
const validateAdminLogin = (schema) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        schemaObj.parse({
            body: req.body,
            query: req.query,
...
const validateBookInput = (schema) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        schemaObj.parse({
            body: req.body,
            query: req.query,
...
const validateBilling = (schema) => (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        schemaObj.parse({
            body: req.body,
            query: req.query,
